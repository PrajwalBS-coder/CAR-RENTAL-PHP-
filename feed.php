					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT name,msg FROM feedback ";
							...
							<tr>
								...
								<td><h3><a href="#"><?php echo $row['msg'] ?></a></h3></td>
                                <td><h3><a href="#"><?php echo $row[''] ?></a></h3></td>
                                <td><h3><a href="#"><?php echo $row[''] ?></a></h3></td>
                                <td><h3><a href="#"><?php echo $row[''] ?></a></h3></td>
                                <td><h3><a href="#"><?php echo $row[''] ?></a></h3></td>
...
<div id="footer">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y/M/D");?> - AMIN'S CAR RENTAL SYSTEM</span>
		<span class="right">
			Design by LEGEND AMIN</a>
		</span>
	</div>
</div>
<!-- End Footer -->

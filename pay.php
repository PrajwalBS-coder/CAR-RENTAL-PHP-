	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				...
				<h5>Paybill Number:<?php echo(rand(10,10002100));?></h5>
				...
				<?php
						if(isset($_POST['pay'])){
					        ...
					        $t=$s * $da;
							$qry = "UPDATE client SET car_id='$cid', mpesa = '$mpesa',days='$da',rent='$t' WHERE id_no = '$id_no'";
							$result = $conn->query($qry);
							if($result == TRUE){
								echo "<script type = \"text/javascript\">
											alert(\"Payment Successfully Done. Wait for Admin Approval $t\");
